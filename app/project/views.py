from flask import request, redirect, url_for, render_template, flash, jsonify, g
...
@project.route('/save_instructions/<int:project_id>/<instructions>', methods=['POST'])
def save_instructions(project_id, instructions):
